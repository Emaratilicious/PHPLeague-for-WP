...
$output .= $fct->select('id_club', $clubs_list).$fct->input('add_club', __('Send', 'phpleague'), array('type' => 'submit', 'class' => 'button'));
...
$output  = $fct->form_open(admin_url('admin.php?page=phpleague_overview&option=team&id_league='.$id_league));
$output .= '<div class="tablenav top"><div class="alignleft actions">'.$fct->input('remove_club', __('Remove', 'phpleague'), array('type' => 'submit', 'class' => 'button')).'</div>';
